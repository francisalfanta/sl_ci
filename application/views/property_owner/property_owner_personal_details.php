											...
											<div class="row">
												...
												<div class="col-md-3"><h6><?php echo form_error('na2'); ?></h6>
													<select class="form-control input-sm" name="na2">
													 	<option value="" <?php echo set_select('na2', '', TRUE); ?> >Select a Nationality</option>
													<?php foreach($country_nationality_list as $nationality) { 
													  echo '<option value="'.$nationality->nationality.'">'.$nationality->nationality.'</option>';
													 } ?>
													</select>
												...
												<div class="col-md-3"><h6><?php echo form_error('na3'); ?></h6>
													...
													<option value="" <?php echo set_select('na3', '', TRUE); ?> >Select a Nationality</option>
													<?php foreach($country_nationality_list as $nationality) { 
													  echo '<option value="'.$nationality->nationality.'">'.$nationality->nationality.'</option>';
													 } ?>
													</select>
							...
							<div class="widget-content padding">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<div class="row">
												<div class="col-md-3"><h6><?php echo form_error('clist1'); ?></h6>												
													<select class="form-control input-sm" name="clist1">
													<option value="" <?php echo set_select('clist1', '', TRUE); ?> >Select a Country</option>
													<?php foreach($country_nationality_list as $nationality) { 
							...
							<div class="widget-content padding">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<div class="row">
												<div class="col-md-3"><h6><?php echo form_error('clist2'); ?></h6>												
													<select class="form-control input-sm" name="clist2">
														<option value="" <?php echo set_select('clist2', '', TRUE); ?> >Select a Country</option>
													<?php foreach($country_nationality_list as $nationality) { 
													  echo '<option value="'.$nationality->country_name.'">'.$nationality->country_name.'</option>';
													 } ?>
													</select>												
							...
							<div class="widget-content padding">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<div class="row">
												<div class="col-md-3"><h6><?php echo form_error('clist3'); ?></h6>
													<select class="form-control input-sm" name="clist3">
													 	<option value="" <?php echo set_select('clist3', '', TRUE); ?> >Select a Country</option>
													<?php foreach($country_nationality_list as $nationality) { 
													  echo '<option value="'.$nationality->country_name.'">'.$nationality->country_name.'</option>';
													 } ?>
													</select>
							...
							<div class="widget-content padding">
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<div class="row">
												<div class="col-md-3"><h6><?php echo form_error('clist4'); ?></h6>
													<select class="form-control input-sm" name="clist4">
													  	<option value="" <?php echo set_select('clist4', '', TRUE); ?> >Select a Country</option>
													<?php foreach($country_nationality_list as $nationality) { 
													  echo '<option value="'.$nationality->country_name.'">'.$nationality->country_name.'</option>';
													 } ?>
													</select>
